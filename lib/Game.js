...
module.exports = class Game {
  ...
  levels(canvas) {
    ...
    this.spawn(spawnNumber, canvas, speed);
  }

  spawn(spawnNumber, canvas, speed) {
    for (let i = 0; i < spawnNumber; i++) {
      ...
      this.enemyArray.push(
        new Enemy(x1, y1, 30, 30, speed),
        new Enemy(x2, y2, 30, 30, speed),
        new Enemy(y1, x1, 30, 30, speed),
        new Enemy(y2, x2, 30, 30, speed)
      );
    }
  }
