...
document.querySelector('#start-game').addEventListener('click', game.roundZero);
...
// need to be able to increase enemy speed and delay game.round start in the future
// eneimies can spawn on player, need to move player to center or enemies off
// canvas when new game.round starts
...
function collisionHandler() {
  projectile.bullets.forEach(function(bullet, bulletIndex, bulletArray) {
    game.enemyArray.forEach(function (enemy, enemyIndex, enemyArray) {
